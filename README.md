...
- Corner family: use a native accessory capacity gauge, matching the built-in battery complication's visible progress track and allowing watchOS to follow whichever corner the wearer chooses; show a sun in the gauge and curve the signed `m:ss` value along the inner bezel.
